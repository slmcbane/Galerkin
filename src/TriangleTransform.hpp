...
TEST_CASE("[Galerkin::Transforms] Test integration through a triangle transform")
{
     ...
     * 9 / 40.
     */
    constexpr auto transform = triangle_transform(std::tuple(0, 0), std::tuple(0, 1), std::tuple(1.5, 1));

    constexpr auto poly1 = Polynomials::make_poly(
        std::tuple(Rationals::rational<3, 4>, Rationals::rational<3, 4>),
        Polynomials::PowersList<Polynomials::Powers<1, 0>, Polynomials::Powers<0, 0>>{});

    constexpr auto poly2 = Polynomials::make_poly(
        std::tuple(Rationals::rational<1, 2>, Rationals::rational<1, 2>, Rationals::rational<1>),
        Polynomials::PowersList<
            Polynomials::Powers<1, 0>, Polynomials::Powers<0, 1>, Polynomials::Powers<0, 0>>{});
