...
TEST_CASE("[Galerkin::Transforms] Test uniform scaling transformation")
{
    ...
    SUBCASE("A one-dimensional uniform scaling transformation with no volume change")
    {
        ...
        REQUIRE(
            transform.partial<0>(Metanomials::metanomial(Metanomials::term(
                Rationals::rational<2>, Metanomials::powers(intgr_constant<2>))))(
                std::tuple(0.2)) == doctest::Approx(0.8));

        // Check integration of a function over the interval.
        REQUIRE(
            transform.integrate<3>(Metanomials::metanomial(Metanomials::term(
                Rationals::rational<1>, Metanomials::powers(intgr_constant<3>)))) ==
            doctest::Approx(0.0));

        // Check integrating the partial derivative.
        REQUIRE(
            transform.integrate<2>(transform.partial<0>(Metanomials::metanomial(Metanomials::term(
                Rationals::rational<1>, Metanomials::powers(intgr_constant<3>))))) ==
            doctest::Approx(transform.integrate<2>(Metanomials::metanomial(Metanomials::term(
                Rationals::rational<3>, Metanomials::powers(intgr_constant<2>))))));
    }
    ...
    SUBCASE("A one dimensional uniform transformation with volume change")
    {
        ...
        REQUIRE(
            transform.inv_jacobian<0, 0>()(std::array<double, 1>{0.2}) == doctest::Approx(2.0));
        ...
        // Check integration of a function over the interval.
        REQUIRE(
            transform.integrate<3>(Metanomials::metanomial(
        ...
        REQUIRE(
            transform.integrate<2>(transform.partial<0>(Metanomials::metanomial(Metanomials::term(
                Rationals::rational<1>, Metanomials::powers(intgr_constant<3>))))) ==
            doctest::Approx(transform.integrate<2>(Metanomials::metanomial(Metanomials::term(
                Rationals::rational<6>, Metanomials::powers(intgr_constant<2>))))));
        ...
        REQUIRE(
            transform.integrate<2>(Metanomials::metanomial(Metanomials::term(
                Rationals::rational<3>, Metanomials::powers(intgr_constant<2>)))) ==
            doctest::Approx(1.0));
    }
    ...
    SUBCASE("A two-dimensional uniform scaling with volume change")
    {
        ...
        REQUIRE(
            transform.detJ()(std::tuple(0.1, Rationals::rational<1, 2>)) ==
            doctest::Approx(2.25));
        ...
        REQUIRE(
            transform.inv_jacobian<0, 1>()(std::array<int, 2>{1, -1}) == Rationals::rational<0>);
        REQUIRE(
            transform.inv_jacobian<1, 1>()(std::array<double, 2>{0.2, -0.2}) ==
            doctest::Approx(2.0 / 3));

        constexpr auto poly = Polynomials::Polynomial<
            double, Metanomials::Powers<1, 1>, Metanomials::Powers<1, 0>,
            Metanomials::Powers<0, 1>, Metanomials::Powers<0, 0>>(0.25, -0.25, -0.25, 0.25);
        ...
        REQUIRE(
            partial1(std::tuple(-Rationals::rational<1, 2>, 0.1)) == doctest::Approx(-1.0 / 4));
        ...
        REQUIRE(
            transform.integrate<2>(partial0 * partial0 + partial1 * partial1) ==
            doctest::Approx(2.0 / 3));
    }
